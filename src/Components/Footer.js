      ...
      <div className='Footer'>
          ...
          <ul>
              <h5>Наши контакты</h5>
                  ...
                  <li><p2><img src='geo.png'></img>Омская область, город Омск,<br/> улица Семиреченская, 97А, корпус 3</p2></li>
              </ul>
          </div>
          <hr/>
          <p1>&copy; 2022 Все права защищены и принадлежат ООО «АгроЗапчасть» </p1>
          </div>
    )
  }
}
